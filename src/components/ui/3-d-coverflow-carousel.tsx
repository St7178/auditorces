...
// Eliminación Información Documentada" (ver /api/sig-actualizaciones) — por eso no hay datos de
// ejemplo por defecto (defaultDishes) ni CTA genérico: "items" es obligatorio y viene siempre de
// datos reales. Los íconos SVG inline del template se reemplazan por lucide-react, ya usado en el
// resto de la app.
